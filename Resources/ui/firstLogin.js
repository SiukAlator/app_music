...
function firstLogin(nav, donde, reload_in, postLogin) {
	...
	function construct() {
		...
		contentTitle.add(title3);
		if (donde == 1) {
			//TODO
			contentTitleFull.add(leftButton);
		}
		contentTitleFull.add(contentTitle);


		boxName = Ti.UI.createView({
		...
		nameInput.value = name + ' ' + last_name;
